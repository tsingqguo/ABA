from extern.pytracking.utils import TrackerParams
from extern.pytracking.features.net_wrappers import NetWithBackbone
...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/workspace/ABA/experiments/kys/kys.pth',   #  /workspace/ABA/experiments/kys/kys.pth
                                 use_gpu=params.use_gpu)     #  /cheng/pytracking-master/ltr/checkpoints/ltr/kys/kys/KYSNet_ep0038.pth.tar
