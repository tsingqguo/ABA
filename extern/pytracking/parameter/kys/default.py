...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/workspace/ABA/experiments/kys/kys.pth',    # /cheng/pytracking-master/ltr/checkpoints/ltr/kys/kys/KYSNet_before_ep0039.pth.tar
    # /workspace/ABA/experiments/kys/kys.pth
