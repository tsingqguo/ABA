...
def load_dataset(dataset):
    ...
    if 'OTB' in dataset:
        ...
        base_path_ = "/media/tsingqguo/data/AttackTracker/testing_dataset/OTB100"
        for v in info.keys():
            path_name = info[v]['name']
            info[v]['image_files'] = [join(base_path_, path_name, 'img', im_f) for im_f in info[v]['image_files']]
