...
def main():
    ...
    parser.add_argument('--train_module', default='stark', type=str, help='Name of module in the "train_settings/" folder.')
    parser.add_argument('--train_name', default='stark_staf', type=str, help='Name of the train settings file.')
