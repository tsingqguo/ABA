...
class DiMPTracker(pyBaseTracker):
    ...
    def track(self,im, x_crop=None,coord =None ,ispert=False):
        ...
        #print(scores_raw.size())
        #vis.heatmap(scores_raw[0][0])
    ...
    def extract_backbone_features(self, im: torch.Tensor, pos: torch.Tensor, scales, sz: torch.Tensor,ispatch=False):
        im_patches, patch_coords = sample_patch_multiscale(im, pos, scales, sz, getattr(self.params, 'border_mode', 'replicate'))
        #print(im_patches.size())
