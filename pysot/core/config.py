...
__C.DATASET.TEMPLATE.SCALE =0# 0.05

__C.DATASET.TEMPLATE.BLUR = 0.0

__C.DATASET.TEMPLATE.FLIP = 0.0

__C.DATASET.TEMPLATE.COLOR = 0#1.0

__C.DATASET.SEARCH = CN()

__C.DATASET.SEARCH.SHIFT = 2

__C.DATASET.SEARCH.SCALE =0.05# 0.18

__C.DATASET.SEARCH.BLUR = 0.0

__C.DATASET.SEARCH.FLIP = 0.0

__C.DATASET.SEARCH.COLOR = 0 #1.0
...
__C.DATASET.NAMES = ['VIDblur']  #  VID    , 'DET', 'YOUTUBEBB'

__C.DATASET.VIDblur = CN()
__C.DATASET.VIDblur.ROOT = '/dataset/training_dataset/vid/cropmyblur'
__C.DATASET.VIDblur.ANNO = '/dataset/training_dataset/vid/train.json'
__C.DATASET.VIDblur.FRAME_RANGE = 100
__C.DATASET.VIDblur.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/dataset/training_dataset/vid/crop511'
__C.DATASET.VID.ANNO = '/dataset/training_dataset/vid/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '/dataset/training_dataset/yt_bb/crop511'
__C.DATASET.YOUTUBEBB.ANNO = '/dataset/training_dataset/yt_bb/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/dataset/training_dataset/coco/crop511'
__C.DATASET.COCO.ANNO = '/dataset/training_dataset/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/dataset/training_dataset/det/crop511'
__C.DATASET.DET.ANNO = '/dataset/training_dataset/det/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = -1

__C.DATASET.VIDEOS_PER_EPOCH = 1000
# ------------------------------------------------------------------------ #
# Backbone options
# ------------------------------------------------------------------------ #
__C.BACKBONE = CN()
